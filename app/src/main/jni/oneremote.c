...
jint Java_com_example_mugeshm_oneremote_Lirc_parse( JNIEnv* env, jobject thiz, jstring filename)
{
...
jobjectArray Java_com_example_mugeshm_oneremote_Lirc_getDeviceList( JNIEnv* env, jobject thiz)
{
...
jobjectArray Java_com_example_mugeshm_oneremote_Lirc_getCommandList( JNIEnv* env, jobject thiz, jstring dev)
{
...
jintArray Java_com_example_mugeshm_oneremote_Lirc_getIrBuffer( JNIEnv* env, jobject thiz,
